...
const SearchResult = ({ community }) => {
  return (
    <>
      <li className="p-2 mb-2 bg-white text-[#2921cc] border border-hidden rounded-md hover:scale-102 hover:shadow-sm hover:shadow-neutral-200 transition duration-200">
        <Link
