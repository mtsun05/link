  ...
  return (
    <>
      <div className="flex flex-col items-center m-5 size-full">
        <div className="text-slate-100 font-[helvetica] border-2 border-gray-400 rounded-lg p-5">
          <h2 className="text-center text-2xl/9 font-bold tracking-tight text-slate-100">
